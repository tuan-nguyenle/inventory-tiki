...
const Addshelve = (props) => {
    ...
    return (
        <div>
            <span style={{ fontSize: "20px" }} size="lg" onClick={() => toggle()} ><i><FaPlus /></i>Shelf</span>
            <Modal isOpen={modal} toggle={() => toggle()} {...props} className="modal-add">
                <ModalHeader toggle={() => toggle()} className="modal-header" >Add New Shelf</ModalHeader>
                <ModalBody>
                    <form>
                        <div className="row">
